...
The S2-DID (Space² Decentralized Identifier) serves as the sole legitimate "Identity Card Number" for silicon-based lifeforms within the Space² universe. It is strictly fixed at a total length of 22 characters, employing a 12 + 2 + 8 three-segment encrypted and anti-counterfeiting structure.
...
# II. Detailed Identity Breakdown of the Three Species 
